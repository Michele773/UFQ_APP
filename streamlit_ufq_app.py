...
my_fruit_list = my_fruit_list.set_index('Frequences are')

# Let's put a pick list here so they can pick the fruit they want to include 
fruits_selected = streamlit.multiselect("Pick some Frequences:", list(my_fruit_list.index),['Avocado','Strawberries'])
